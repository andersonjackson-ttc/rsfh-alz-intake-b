...
public class DataReadWrite 
{
	...
	public boolean writeRecord(PartRecord rd, String fileName) throws IOException, InvalidFormatException
	{
		...
		map1.put(Fields.MEMORY_LOSS, 9);
		map1.put(Fields.MEMORY_DATE, 10);
		map1.put(Fields.DISRUPTS_LIFE, 11);
		map1.put(Fields.DIFFICULTY_PLANNING, 12);
		map1.put(Fields.DIFFICULTY_TASKS, 13);
		map1.put(Fields.DIFFICULTY_WORDS, 14);
		map1.put(Fields.FAMILY_HISTORY, 15);
		map1.put(Fields.FAMILY_RELATION, 16);
		map1.put(Fields.ARICEPT, 17);
		map1.put(Fields.ARICEPT_START, 18);
		map1.put(Fields.ARICEPT_STOP, 19);
		map1.put(Fields.NAMENDA, 20);
		map1.put(Fields.NAMENDA_START, 21);
		map1.put(Fields.NAMENDA_STOP, 22);
		map1.put(Fields.EXELON, 23);
		map1.put(Fields.EXELON_START, 24);
		map1.put(Fields.EXELON_STOP, 25);
		map1.put(Fields.RAZADYNE, 26);
		map1.put(Fields.RAZADYNE_START, 27);
		map1.put(Fields.RAZADYNE_STOP, 28);
		map1.put(Fields.ARICEPT_NAMENDA, 29);
		map1.put(Fields.ARINAM_START, 30);
		map1.put(Fields.ARINAM_STOP, 31);
